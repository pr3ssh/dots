...
`site: The Dots` – change this to your website's name
...
## Directory, posts and pages

These control the main content of your website, and are found inside the `_directory`, `_posts` and `_pages` folders.
